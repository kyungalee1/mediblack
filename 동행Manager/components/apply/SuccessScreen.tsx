  ...
  return (
    ...
    >
      ...
      <p className="mt-2 max-w-sm text-sm leading-relaxed text-slate-500">
        자격·경력 검토 후{" "}
        <span className="font-semibold text-navy">2영업일 이내</span>에
        연락드립니다.
      </p>
      ...
      <ul className="mt-6 w-full space-y-3 text-left">
        <li className="flex items-start gap-3 rounded-2xl bg-white p-4 shadow-sm ring-1 ring-slate-100">
          <ClipboardList className="mt-0.5 h-5 w-5 shrink-0 text-teal" />
          <div>
            <p className="text-sm font-bold text-navy">다음 단계</p>
            <p className="mt-0.5 text-sm text-slate-500">
              승인 후 MediBlack 접수 건에 매칭되며, 동행·리포트 업무를
              안내드립니다.
            </p>
          </div>
        </li>
        <li className="flex items-start gap-3 rounded-2xl bg-white p-4 shadow-sm ring-1 ring-slate-100">
          ...
          <div>
            ...
            <p className="mt-0.5 text-sm text-slate-500">
              등록하신 번호로 면접·오리엔테이션 안내가 발송될 수 있습니다.
            </p>
          </div>
        </li>
      </ul>
